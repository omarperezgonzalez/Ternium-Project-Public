...
$(document).ready(function() {
    $("body").delegate("#menu_list button","click",function() {
        ...
        if (idx=="download") {
            ...
            // una vez el usuario le da guardar ya se tienen guardadas todas las opciones que el usuario selecciono
            // ejemplo la seleccion de los ojos se guarda como current_eyes
            // lo que venia abajo de la linea 85-99 es lo que se hacia en caso de descargar pero ahora solo se tendria que cambiar a pasar
            // la informacion que tenemos a la base de datos
            ...
            $("#options_title").html("SELECCIONA "+selected);
            $("#options_div").html("");
            var html = "";
            switch (idx) {
                case "skincolor":
...
// const boton = document.getElementById("downloadAvatar") ;
...
//         Eyes = current_eyes,
//         Eyebrows: current_eyebrows,
//         Mouth: current_mouth ,
//         HairStyle : current_hairstyle ,
//         HairColor : current_haircolor ,
//         FacialHair : current_facialhair ,
//         Clothes : current_clothe ,
//         FabricColor : current_fabriccolors,
//         Glasses : current_glasses ,
//         GlassesOpac : current_glassopacity ,
//         Accesories : current_accesories ,
//         Tattoos : current_tattoos ,
...
//     };
//     const respuesta = await fetch("/Avatar", opciones) ;
//     const datos = await respuesta.json();
//     if (datos.rowsAffected.length == 1) {
//         alert("Avatar Registrado...");
//       } else {
//         storage.clear();
//         alert("Hubo un error...");
//       }
